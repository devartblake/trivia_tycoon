...
final List<TierData> tierList = [
  TierData(
      id: 1, name: "Bronze", icon: Icons.emoji_events, color: Colors.brown),
  ...
  TierData(
      id: 5, name: "Diamond", icon: Icons.diamond, color: Colors.blueAccent),
  TierData(
      id: 6,
      name: "Master",
...
class _RankTabBarWidgetState extends State<RankTabBarWidget>
  ...
  void initState() {
    ...
    _tabController = TabController(
        length: tierList.length, vsync: this, initialIndex: widget.initialTier);
