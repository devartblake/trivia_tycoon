...
class ComplianceStatus {
  ...
  factory ComplianceStatus.fromJson(Map<String, dynamic> json) =>
      ComplianceStatus(
        ...
        requiredActions:
            (json['requiredActions'] as List<dynamic>? ?? []).cast<String>(),
  ...
  bool get isGeoBlocked =>
      geoStatus == GeoStatus.restricted || geoStatus == GeoStatus.blocked;
...
class DataSubjectRequestResult {
  ...
  factory DataSubjectRequestResult.fromJson(Map<String, dynamic> json) =>
