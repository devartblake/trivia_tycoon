...
class _RecoverCard extends ConsumerStatefulWidget {
  const _RecoverCard({
  ...
  @override
  ConsumerState<_RecoverCard> createState() => _RecoverCardState();
}

class _RecoverCardState extends ConsumerState<_RecoverCard>
