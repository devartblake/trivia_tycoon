...
class FlowConnectLevelGenerator {
  static FlowConnectLevelData generateLevel(int gridSize, FlowConnectDifficulty difficulty) {
    ...
    if (path.isEmpty) {
      ...
      return FlowConnectLevelData(grid: [], gridSize: gridSize, totalNumbers: 0, solutionPath: []);
    }
  ...
  static List<int> _selectCheckpoints(List<FlowConnectPathPoint> path, int count) {
    final indices = <int>{};
