...
/// 2) Fallback: generated Flutter AssetManifest (bundled assets only)
...
class AvatarAssetLoader {
  ...
  static Future<List<AvatarAssetRef>> _loadBundledImagesRefs() async {
    ...
    // Fallback: generated Flutter AssetManifest
  ...
  static Future<List<String>> _loadFromAssetManifest(
    ...
    try {
      ...
      final allAssets = manifest.listAssets().where((String key) {
