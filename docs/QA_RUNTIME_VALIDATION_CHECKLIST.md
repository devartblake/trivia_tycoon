...
- [~] Admin API pagination/error-envelope mapping verified against contract (completed on Admin Users + Question Bank + Admin User Detail flows; remaining admin lists pending).
