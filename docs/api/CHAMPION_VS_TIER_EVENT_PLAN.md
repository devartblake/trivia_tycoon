...
| **2 — Live rounds** | Synchronized round orchestration over SignalR: start gun, per-round question broadcast, answer window, simultaneous elimination, champion-fall detection, reconnect handling | ~3–4 days | Phase 1 + MatchHub |
