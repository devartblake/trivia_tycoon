...
- [ ] Move toward the documented 40% coverage target for `lib/game/` and `lib/core/` (remaining: store models, message/social models, player_inbox_item, tier_model, power_up).
