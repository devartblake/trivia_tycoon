...
- [ ] Move toward the documented 40% coverage target for `lib/game/` and `lib/core/` (remaining: message_models, group_chat_models, player_inbox_item, tier_model, power_up, collection_item).
